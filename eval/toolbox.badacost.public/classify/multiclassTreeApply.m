function hs = multiclassTreeApply( X, tree, maxDepth, minWeight, nThreads )
% Apply learned binary decision tree classifier.
%
% USAGE
%  hs = multiclassTreeApply( X, tree, [maxDepth], [minWeight], [nThreads] )
%
% INPUTS
...
hs = tree.hs(forestInds(single(X),tree.thrs,tree.fids,tree.child,nThreads));
