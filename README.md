...
```shell
cd eval
run [eval_bsds.m](https://github.com/MengyangPu/EDTER/tree/main/eval/eval_bsds.m)
```
#### NYUD
Download the matfile(NYUD) from [here](https://pan.baidu.com/s/1LEeoOKkzdcewmPhq5z86wA)(Code:25p8).<br/>
```shell
cd eval
run [eval_nyud.m](https://github.com/MengyangPu/EDTER/tree/main/eval/eval_nyud.m)
```
